...
export const work: Work[] = [
  ...
  },
  {
    ...
    description: [
      'For my Google UX project, I created two User Journey Maps built off the personas I have created here (this will be a link to user personas).',
  ...
  },
  {
    ...
    description: [
      'The experience users or customers have can greatly affect how they feel about a business. It is important to understand how a user or a client feels about thier user journey on a specific website. During my preliminary research for DS Store, an E-commerce website for Baker Hughes, I found a lot of dissatisfaction amongst users of this application.',
      "I decided to follow a typical user's journey on this website and came across many discrepancies within the site mysef.",
      'I then used a company wide used Heuristic Evaluation template that focused on every aspect of the site such as the Homepage, Task Orientation, Navigation and IA, Forms and Data Entry, Trust and Credibility, Writing, Page Layout, and Search. I tested each functionality in the template and provided a score of 1 to -1 with 1 being exceptional and -1 being dissatisfaction.',
      'After scoring each functionality, I then anaylzed my data and catgorized each aspect of the website and produced a raw score as well as a score percentage. I produced visual data for my business owners and stakeholders that highlighted what areas the website excels in vs what areas the website needs immediate attention to increase User Journey.',
  ...
  },
  {
    ...
    description: [
      ...
      'Before creating a functioning prototype, I started by sketching out and eventually turning my designs into  lo-fi Wireframes using Figma. Each Wireframe I created ensures that I solved a real problem users typically faced while working with food delivery apps on thier phones.I chose to stick with a lower amount of complexity as I was inspired by my research and wanted to get ideas designed quickly.',
      'While designing my Wireframes, I incorporated my knowledge of Gestalt Principles. Gestalt Principles describe how humans group similar elements, recognize patterns, and simplify complex images when we perceive objects.',
      'For the first principle, Similarity, I wanted to keep "like with like" for consistency. For example, in the Rewards page, I made sure that the placeholders for incons are the same shape and size in all my  wireframes.',
    ...
    image: 'work-4.png',
    views: getRandomNumber({ max: 30, min: 18 }),
    tags: ['Wireframes', 'UX', 'Google UX Course', 'Mobile'],
    role: 'UX Designer',
    timeline: '3 days',
    platform: 'Mobile',
    type: 'Wireframes',
